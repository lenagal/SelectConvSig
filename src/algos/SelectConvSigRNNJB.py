...
class SelectConvSigRNNJB:
    ...
    def build_model(self,input_shape,signature_deg,classes):
        bones_graph=self.data_wrapper.get_bones_graph()
        joints_graph=self.data_wrapper.get_joints_graph()
        ...
        # outputs logits
        output_layer = Dense(classes, activation=None, name='output_layer'+'_sig_'+str(signature_deg))(output_layer)
